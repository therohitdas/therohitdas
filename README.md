...
|---------|-------------|-------|
| 🎬 **[TranscriptAPI](https://transcriptapi.com)** | YouTube transcript API + MCP support | **15M+ transcripts/mo** |
| 📝 **[YouTubeToTranscript](https://youtubetotranscript.com)** | Built it → Sold for $10K → Still maintain | **2M+ Google clicks/mo** |
| 🧩 **[Chrome Extension](https://chromewebstore.google.com/detail/youtube-to-transcript-ai/bcmoplgjpddohaelhnnodojbamdobbhc)** | More features than the website | **20K+ installs** |
...
**2019** — Built **quizprank.xyz** from a room with no electricity. First viral hit.
...
**2020-2021** — COVID era peak
- **1.7M daily users** at peak (single day)
- secretm.me, deardost.com, Mixal.xyz went viral
